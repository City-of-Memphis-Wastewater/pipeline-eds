...
from pyhabitat import launch_browser_when_ready 
import logging
...
def launch_server_for_web_gui(app, host: str = "127.0.0.1", port: int = 8082):
    ...
    # This completely replaces your manual launch_browser_when_ready worker block
    launch_browser_when_ready(url, timeout=5.0, poll_interval=0.2)
    time.sleep(0.5)
