# src/pipeline_eds/atomic_telemetry.py
...
class AtomicTelemetryLogger:
    ...
    """
    def __init__(self, filepath: str, series_definition: SeriesDefinition) -> None:
    ...
    def consume_observation(self, obs: Observation) -> None:
        """
        ...
        log_entry = {
            "key": self.series_definition.id, #self.series.label,
            "t": obs.timestamp,
            "v": obs.value,
            "idx": obs.index,
...
import time
from pipeline_eds.schema import Observation
from pipeline_eds.plot_buffer import PlotBuffer
